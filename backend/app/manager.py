...
class SalonManager:
    ...
    def crear_tipo_servicio(self, nombre: str, descripcion: str,
                           porcentaje_comision: float, precio_por_defecto: Optional[Decimal] = None) -> Result[TipoServicio, ValidationError | DuplicateError]:
        """
    ...
    def actualizar_tipo_servicio(self, nombre: str,
                                 porcentaje_comision: float, precio_por_defecto: Optional[Decimal] = None) -> Result[TipoServicio, ValidationError | NotFoundError]:
        """
